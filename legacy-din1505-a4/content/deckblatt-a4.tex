...
\thispagestyle{empty}
%
% CRITICAL GEOMETRY OVERRIDE: Force symmetric margins, zero bindingoffset, no head/foot space
% This makes the titlepage layout INDEPENDENT of document-wide bindingoffset/header settings
\newgeometry{
  a4paper,
  left=25mm,
  right=25mm,
