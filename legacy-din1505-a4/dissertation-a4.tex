...
% Deckblatt (title page) macros - refactored to match KIT Bau example layout
% NOTE: Replace these placeholder values with your actual information
\newcommand{\doktorgrad}{DOKTOR-INGENIEURIN}              % or DOKTOR-INGENIEURS
\newcommand{\facultyname}{Fakultät für Bauingenieur-, Geo- und Umweltwissenschaften}
\newcommand{\institutname}{Karlsruher Institut für Technologie (KIT)}
\newcommand{\submissiontype}{genehmigte}                  % or "eingereichte" for submission
\newcommand{\authorname}{Mareike Kohm M.Sc.}              % Full name with academic suffix
\newcommand{\birthline}{geb. in Karlsruhe}                % or "aus [Geburtsort, Land]"

% Optional examination details (leave empty to hide from title page)
\newcommand{\defensedate}{1. Februar 2025}                % Defense date
\newcommand{\referee}{Prof. Dr.-Ing. Max Mustermann}      % Main referee
\newcommand{\coreferee}{Prof. Dr.-Ing. Erika Musterfrau}  % Co-referee
