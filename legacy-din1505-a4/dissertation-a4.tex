...
\newcommand{\authorname}{Anna Schmidt M.Sc.}              % Full name with academic suffix
\newcommand{\birthline}{geb. in Stuttgart}                % or "aus [Geburtsort, Land]"

% Optional examination details (leave empty to hide from title page)
\newcommand{\defensedate}{15. März 2025}                  % Defense date
\newcommand{\referee}{Prof. Dr.-Ing. Hans Müller}         % Main referee
\newcommand{\coreferee}{Prof. Dr.-Ing. Maria Weber}       % Co-referee
